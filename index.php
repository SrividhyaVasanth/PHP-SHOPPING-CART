...
<?php
session_start();
$connect = mysqli_connect("localhost", "newuser", "P4\$\$w0rd123", "cart");
...
<html>
 ...
 <br />
 <br />
 <h3 align="center">Shopping Cart With PHP And MySql
 <br /><br />
 <?php
 ...
 ?>
 <tr>
<td><?php echo $values["name"]; ?>Basketball</td>
 <td><?php echo $values["quantity"]; ?></td>
 <td>$ <?php echo $values["price"]; ?>600</td>
...
<a href="reg.php" class="btn btn-info btn-lg">
